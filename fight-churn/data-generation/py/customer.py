...
class Customer:
    ...
    def __init__(
        ...
        if start_of_month:
            ...
            self.date_of_birth = start_of_month + relativedelta.relativedelta(
                years=-int(self.age),
        ...
        if satisfaction is None:
            ...
            self.satisfaction_propensity = np.power(
                2.0, random.uniform(-1.5, 1.5) + age_contrib
            )
        else:
            ...
            for event_idx, rate in enumerate(self.behave_per_day):
                ...
                for n in range(0, new_count):
                    event_time = datetime.combine(
                        the_date, time(randrange(24), randrange(60), randrange(60))
                    )
